...
def main():
    ...
    soup = BeautifulSoup(open('NisApi.src.ja.html'))
    ...
    for d in soup.findAll('time'):
        ...
        d.clear()
        d.append(curTime.strftime('%Y/%m/%d %H:%M'))
    ...
    open('index.ja.html', 'w').write(soupTab(soup, 'utf-8'))
    print("index.ja.html generated")
